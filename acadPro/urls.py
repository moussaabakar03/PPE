"""
URL configuration for acadPro project.
...
urlpatterns = [
    ...
    path('comptable/',  include('comptable.urls')),
    ...
    path('admission_Inscription/', views.admission_Inscription, name="admission_Inscription"),
